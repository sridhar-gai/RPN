...
ERROR = "ERROR"
NOT_A_VALID_OPERATOR = "INVALID_OPERATOR"
DIVIDE_BY_ZERO_ERROR = "DIVIDE_BY_ZERO"
INVALID_EXPRESSION_ERROR = "INVALID_EXPRESSION"
UNSUPPORTED_OPERATION_ERROR = "UNSUPPORTED_OPERATION"
DELIMITER = ","
        ...
        try:
            ...
            for item in input_list:
                if self.is_valid_operator(item):
                    ...
                    return NOT_A_VALID_OPERATOR if item else INVALID_EXPRESSION_ERROR
